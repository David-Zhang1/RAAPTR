...
simDataDir = '\Users\lian\Documents\reference\DataAnalysis\PTA\RAAPTR\mdc0315';

outDir = [simDataDir,filesep,'mdc0315',filesep,'summary'];
mkdir(outDir);
inDataDir = [simDataDir,filesep,'perfevalResults'];
